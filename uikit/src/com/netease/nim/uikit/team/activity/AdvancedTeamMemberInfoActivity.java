...
public class AdvancedTeamMemberInfoActivity extends UI implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initMemberInfo();
        if (!NIMClient.getService(FriendService.class).isMyFriend(account) && !NimUIKit.getAccount().equals(account)) {
    ...
    private void findViews() {
        btn_add = findView(R.id.add_buddy);
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.add_buddy) {
//            final EditText editText = new EditText(AdvancedTeamMemberInfoActivity.this);
//            editText.setHint("    验证信息");
            View view = LayoutInflater.from(AdvancedTeamMemberInfoActivity.this).inflate(R.layout.layout_edit, null);
            final EditText editText = (EditText) view.findViewById(R.id.edit);
            AlertDialog.Builder builder = new AlertDialog.Builder(AdvancedTeamMemberInfoActivity.this).setTitle("添加好友")
...
//                            map.put("accid", NimUIKit.getAccount());
//                            map.put("faccid", account);
//                            map.put("type", "2");
//                            map.put("msg", TextUtils.isEmpty(msg) ? "" : msg);

                            OkHttpUtils.get()
                                    .addParams("accid", NimUIKit.getAccount())
                                    .addParams("faccid", account)
                                    .addParams("type", "2")
                                    .addParams("msg", TextUtils.isEmpty(msg) ? "" : msg)
//                                    .url("http://60.28.240.121:4505/index/makeFriend")
                                    .url("https://www.anxinchat.com:11443/index/makeFriend")
                                ...
                                public void onError(okhttp3.Call call, Exception e, int id) {
                                    DialogMaker.dismissProgressDialog();
                                    Toast.makeText(AdvancedTeamMemberInfoActivity.this, "网络有误，添加失败", Toast.LENGTH_SHORT).show();
                                }
                                ...
                                public void onResponse(String response, int id) {
                                    ...
                                    if (jsonObject.getString("code").equals("200")) {
                                        ...
                                        Toast.makeText(AdvancedTeamMemberInfoActivity.this, jsonObject.getString("msg"), Toast.LENGTH_SHORT).show();
                                    }
                                    DialogMaker.dismissProgressDialog();
                                }
                            });
