package com.aqtx.app.rts.activity;
...
import com.aqtx.app.rts.doodle.DoodleView;
import com.aqtx.app.rts.doodle.action.MyPath;
import com.aqtx.app.session.extension.RTSAttachment;
import com.aqtx.app.rts.ActionTypeEnum;
import com.aqtx.app.rts.doodle.SupportActionType;
import com.aqtx.app.rts.doodle.TransactionCenter;
...
public class RTSActivity extends UI implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.rts_activity);
    ...
    private void initActionBarButton() {
        TextView closeSessionBtn = findView(com.aqtx.app.R.id.action_bar_right_clickable_textview);
        closeSessionBtn.setText(com.aqtx.app.R.string.close);
        closeSessionBtn.setBackgroundResource(com.aqtx.app.R.drawable.nim_message_button_bottom_send_selector);
        closeSessionBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EasyAlertDialog dialog = EasyAlertDialogHelper.createOkCancelDiolag(RTSActivity.this,
                        getString(com.aqtx.app.R.string.end_session_tip_head),
                        getString(com.aqtx.app.R.string.end_session_tip_content),
                        getString(com.aqtx.app.R.string.ok), getString(com.aqtx.app.R.string.cancel), true, listener);
                dialog.show();
            }
        });
    }
    ...
    private void findViews() {
        startSessionLayout = findViewById(com.aqtx.app.R.id.start_session_layout);
        sessionLayout = findViewById(com.aqtx.app.R.id.session_layout);

        headImage = (HeadImageView) findViewById(com.aqtx.app.R.id.head_image);
        sessionStepText = (TextView) findViewById(com.aqtx.app.R.id.session_step_text);
        nameText = (TextView) findViewById(com.aqtx.app.R.id.name);
        calleeAckLayout = findViewById(com.aqtx.app.R.id.callee_ack_layout);
        acceptBtn = (Button) findViewById(com.aqtx.app.R.id.accept);
        rejectBtn = (Button) findViewById(com.aqtx.app.R.id.reject);
        endSessionBtn = (Button) findViewById(com.aqtx.app.R.id.end_session);
        doodleView = (DoodleView) findViewById(com.aqtx.app.R.id.doodle_view);
        backBtn = (Button) findViewById(com.aqtx.app.R.id.doodle_back);
        clearBtn = (Button) findViewById(com.aqtx.app.R.id.doodle_clear);
        audioSwitchBtn = (Button) findViewById(com.aqtx.app.R.id.audio_switch);
    ...
    private void initStartSessionViews() {
        initAccountInfoView();
        sessionStepText.setText(com.aqtx.app.R.string.start_session);
    ...
    private void initIncomingSessionViews() {
        initAccountInfoView();
        sessionStepText.setText(com.aqtx.app.R.string.receive_session);
    ...
    private Observer<RTSCalleeAckEvent> calleeAckEventObserver = new Observer<RTSCalleeAckEvent>() {
        ...
        public void onEvent(RTSCalleeAckEvent rtsCalleeAckEvent) {
            if (rtsCalleeAckEvent.getEvent() == RTSEventType.CALLEE_ACK_AGREE) {
                ...
                Toast.makeText(RTSActivity.this, com.aqtx.app.R.string.callee_reject, Toast.LENGTH_SHORT).show();
                onFinish(false);
            }
        }
    };
    ...
    private Observer<RTSCommonEvent> endSessionObserver = new Observer<RTSCommonEvent>() {
        ...
        public void onEvent(RTSCommonEvent rtsCommonEvent) {
            Toast.makeText(RTSActivity.this, com.aqtx.app.R.string.target_has_end_session, Toast.LENGTH_SHORT).show();
            onFinish(false);
        }
    };
    ...
    private Observer<RTSTimeOutEvent> timeoutObserver = new Observer<RTSTimeOutEvent>() {
        ...
        public void onEvent(RTSTimeOutEvent rtsTimeOutEvent) {
            Toast.makeText(RTSActivity.this,
                    (rtsTimeOutEvent == RTSTimeOutEvent.OUTGOING_TIMEOUT) ? getString(com.aqtx.app.R.string.callee_ack_timeout) :
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.aqtx.app.R.id.accept:
                acceptSession();
                break;
            case com.aqtx.app.R.id.reject:
                endSession();
                break;
            case com.aqtx.app.R.id.end_session:
                endSession();
                break;
            case com.aqtx.app.R.id.doodle_back:
                doodleBack();
                break;
            case com.aqtx.app.R.id.doodle_clear:
                clear();
                break;
            case com.aqtx.app.R.id.audio_switch:
                audioSwitch();
                break;
            default:
                break;
    ...
    private void audioSwitch() {
        ...
        audioSwitchBtn.setBackgroundResource(audioOpen ? com.aqtx.app.R.drawable.icon_audio_open : com.aqtx.app.R.drawable.icon_audio_close);
    ...
    private void initAudioSwitch() {
        ...
        audioSwitchBtn.setBackgroundResource(com.aqtx.app.R.drawable.icon_audio_close);
    }
}
