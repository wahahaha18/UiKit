...
public class AVChatSoundPlayer {
    ...
    public synchronized void play(RingerTypeEnum type) {
        ...
        switch (type) {
        case NO_RESPONSE:
            ringId = com.aqtx.app.R.raw.avchat_no_response;
            loop = false;
            break;
        case PEER_BUSY:
            ringId = com.aqtx.app.R.raw.avchat_peer_busy;
            loop = false;
            break;
        case PEER_REJECT:
            ringId = com.aqtx.app.R.raw.avchat_peer_reject;
            loop = false;
            break;
        case CONNECTING:
            ringId = com.aqtx.app.R.raw.avchat_connecting;
            loop = true;
            break;
        case RING:
            ringId = com.aqtx.app.R.raw.avchat_ring;
            loop = true;
            break;
        }
