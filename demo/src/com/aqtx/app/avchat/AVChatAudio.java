...
import com.aqtx.app.avchat.constant.CallStateEnum;
import com.aqtx.app.avchat.widgets.ToggleListener;
import com.aqtx.app.avchat.widgets.ToggleState;
import com.aqtx.app.avchat.widgets.ToggleView;
...
public class AVChatAudio implements View.OnClickListener, ToggleListener{
    // constant
    private static final int[] NETWORK_GRADE_DRAWABLE = new int[]{com.aqtx.app.R.drawable.network_grade_0, com.aqtx.app.R.drawable.network_grade_1, com.aqtx.app.R.drawable.network_grade_2, com.aqtx.app.R.drawable.network_grade_3};
    private static final int[] NETWORK_GRADE_LABEL = new int[]{com.aqtx.app.R.string.avchat_network_grade_0, com.aqtx.app.R.string.avchat_network_grade_1, com.aqtx.app.R.string.avchat_network_grade_2, com.aqtx.app.R.string.avchat_network_grade_3};
    ...
    public void onCallStateChange(CallStateEnum state){
        ...
        switch (state){
            case OUTGOING_AUDIO_CALLING: //拨打出的免费通话
                ...
                showProfile();//对方的详细信息
                showNotify(com.aqtx.app.R.string.avchat_wait_recieve);
            ...
            case INCOMING_AUDIO_CALLING://免费通话请求
                setSwitchVideo(false);
                showProfile();//对方的详细信息
                showNotify(com.aqtx.app.R.string.avchat_audio_call_request);
                setMuteSpeakerHangupControl(false);
                setRefuseReceive(true);
                receiveTV.setText(com.aqtx.app.R.string.avchat_pickup);
                break;
            case AUDIO:
            ...
            case AUDIO_CONNECTING:
                showNotify(com.aqtx.app.R.string.avchat_connecting);
                break;
            case INCOMING_AUDIO_TO_VIDEO:
                showNotify(com.aqtx.app.R.string.avchat_audio_to_video_invitation);
                setMuteSpeakerHangupControl(false);
                setRefuseReceive(true);
                receiveTV.setText(com.aqtx.app.R.string.avchat_receive);
                break;
            default:
                break;
        }
    ...
    private void findViews() {
        ...
        switchVideo = rootView.findViewById(com.aqtx.app.R.id.avchat_audio_switch_video);
        switchVideo.setOnClickListener(this);

        headImg = (HeadImageView) rootView.findViewById(com.aqtx.app.R.id.avchat_audio_head);
        nickNameTV = (TextView) rootView.findViewById(com.aqtx.app.R.id.avchat_audio_nickname);
        time = (Chronometer) rootView.findViewById(com.aqtx.app.R.id.avchat_audio_time);
        wifiUnavailableNotifyTV = (TextView) rootView.findViewById(com.aqtx.app.R.id.avchat_audio_wifi_unavailable);
        notifyTV = (TextView) rootView.findViewById(com.aqtx.app.R.id.avchat_audio_notify);
        netUnstableTV = (TextView) rootView.findViewById(com.aqtx.app.R.id.avchat_audio_netunstable);

        mute_speaker_hangup = rootView.findViewById(com.aqtx.app.R.id.avchat_audio_mute_speaker_huangup);
        View mute = mute_speaker_hangup.findViewById(com.aqtx.app.R.id.avchat_audio_mute);
        muteToggle = new ToggleView(mute, ToggleState.OFF, this);
        View speaker = mute_speaker_hangup.findViewById(com.aqtx.app.R.id.avchat_audio_speaker);
        speakerToggle = new ToggleView(speaker, ToggleState.OFF, this);
        View record = mute_speaker_hangup.findViewById(com.aqtx.app.R.id.avchat_audio_record);
        recordToggle = new ToggleView(record, ToggleState.OFF, this);
        hangup = mute_speaker_hangup.findViewById(com.aqtx.app.R.id.avchat_audio_hangup);
        hangup.setOnClickListener(this);

        recordToggle.disable(false);

        refuse_receive = rootView.findViewById(com.aqtx.app.R.id.avchat_audio_refuse_receive);
        refuseTV = (TextView) refuse_receive.findViewById(com.aqtx.app.R.id.refuse);
        receiveTV = (TextView) refuse_receive.findViewById(com.aqtx.app.R.id.receive);
        refuseTV.setOnClickListener(this);
        receiveTV.setOnClickListener(this);

        recordView = rootView.findViewById(com.aqtx.app.R.id.avchat_record_layout);
        recordTip = rootView.findViewById(com.aqtx.app.R.id.avchat_record_tip);
        recordWarning = rootView.findViewById(com.aqtx.app.R.id.avchat_record_warning);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.aqtx.app.R.id.avchat_audio_hangup:
                listener.onHangUp();
                break;
            case com.aqtx.app.R.id.refuse:
                listener.onRefuse();
                break;
            case com.aqtx.app.R.id.receive:
                listener.onReceive();
                break;
            case com.aqtx.app.R.id.avchat_audio_mute:
                listener.toggleMute();
                break;
            case com.aqtx.app.R.id.avchat_audio_speaker:
                listener.toggleSpeaker();
                break;
            case com.aqtx.app.R.id.avchat_audio_switch_video:
                listener.audioSwitchVideo();
                break;
            case com.aqtx.app.R.id.avchat_audio_record:
