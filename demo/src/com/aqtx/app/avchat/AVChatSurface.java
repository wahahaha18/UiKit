...
public class AVChatSurface {
    ...
    private void findViews() {
        ...
        if(surfaceRoot != null){
            ...
            smallSizePreviewFrameLayout = (FrameLayout) surfaceRoot.findViewById(com.aqtx.app.R.id.small_size_preview_layout);
            smallSizePreviewLayout = (LinearLayout) surfaceRoot.findViewById(com.aqtx.app.R.id.small_size_preview);
            smallSizePreviewCoverImg = (ImageView) surfaceRoot.findViewById(com.aqtx.app.R.id.smallSizePreviewCoverImg);
            smallSizePreviewFrameLayout.setOnTouchListener(touchListener);

            largeSizePreviewLayout = (LinearLayout) surfaceRoot.findViewById(com.aqtx.app.R.id.large_size_preview);
            largeSizePreviewCoverLayout = surfaceRoot.findViewById(com.aqtx.app.R.id.notificationLayout);
    ...
    private void showNotificationLayout(int closeType){
        ...
        switch (closeType){
            case PEER_CLOSE_CAMERA:
                textView.setText(com.aqtx.app.R.string.avchat_peer_close_camera);
                break;
            case LOCAL_CLOSE_CAMERA:
                textView.setText(com.aqtx.app.R.string.avchat_local_close_camera);
                break;
            case AUDIO_TO_VIDEO_WAIT:
                textView.setText(com.aqtx.app.R.string.avchat_audio_to_video_wait);
                break;
            default:
                return;
        }
