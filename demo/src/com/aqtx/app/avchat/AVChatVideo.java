...
public class AVChatVideo implements View.OnClickListener, ToggleListener {
    ...
    private void findViews() {
        if(init || root == null )
            return;
        topRoot = root.findViewById(com.aqtx.app.R.id.avchat_video_top_control);
        switchAudio = topRoot.findViewById(com.aqtx.app.R.id.avchat_video_switch_audio);
        switchAudio.setOnClickListener(this);
        time = (Chronometer) topRoot.findViewById(com.aqtx.app.R.id.avchat_video_time);
        netUnstableTV = (TextView) topRoot.findViewById(com.aqtx.app.R.id.avchat_video_netunstable);

        middleRoot = root.findViewById(com.aqtx.app.R.id.avchat_video_middle_control);
        headImg = (HeadImageView) middleRoot.findViewById(com.aqtx.app.R.id.avchat_video_head);
        nickNameTV = (TextView) middleRoot.findViewById(com.aqtx.app.R.id.avchat_video_nickname);
        notifyTV = (TextView) middleRoot.findViewById(com.aqtx.app.R.id.avchat_video_notify);

        refuse_receive = middleRoot.findViewById(com.aqtx.app.R.id.avchat_video_refuse_receive);
        ...
        recordView = root.findViewById(com.aqtx.app.R.id.avchat_record_layout);
        recordTip = recordView.findViewById(com.aqtx.app.R.id.avchat_record_tip);
        recordWarning = recordView.findViewById(com.aqtx.app.R.id.avchat_record_warning);

        bottomRoot = root.findViewById(com.aqtx.app.R.id.avchat_video_bottom_control);
        switchCameraToggle = new ToggleView(bottomRoot.findViewById(com.aqtx.app.R.id.avchat_switch_camera), ToggleState.DISABLE, this);
        closeCameraToggle = new ToggleView(bottomRoot.findViewById(com.aqtx.app.R.id.avchat_close_camera), ToggleState.DISABLE, this);
        muteToggle = new ToggleView(bottomRoot.findViewById(com.aqtx.app.R.id.avchat_video_mute), ToggleState.DISABLE, this);
        recordToggle = new ToggleView(bottomRoot.findViewById(com.aqtx.app.R.id.avchat_video_record), ToggleState.DISABLE, this);
        hangUpImg = (ImageView) bottomRoot.findViewById(com.aqtx.app.R.id.avchat_video_logout);
    ...
    public void onCallStateChange(CallStateEnum state) {
        ...
        switch (state){
            ...
            case INCOMING_VIDEO_CALLING:
                showProfile();//对方的详细信息
                showNotify(com.aqtx.app.R.string.avchat_video_call_request);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.aqtx.app.R.id.avchat_video_logout:
                listener.onHangUp();
                break;
            ...
            case com.aqtx.app.R.id.receive:
                listener.onReceive();
                break;
            case com.aqtx.app.R.id.avchat_video_mute:
                listener.toggleMute();
                break;
            case com.aqtx.app.R.id.avchat_video_switch_audio:
                if(isInSwitch) {
                    Toast.makeText(context, com.aqtx.app.R.string.avchat_in_switch, Toast.LENGTH_SHORT).show();
                } else {
                    listener.videoSwitchAudio();
                }
                break;
            case com.aqtx.app.R.id.avchat_switch_camera:
                listener.switchCamera();
                break;
            case com.aqtx.app.R.id.avchat_close_camera:
                listener.closeCamera();
                break;
            case com.aqtx.app.R.id.avchat_video_record:
