package com.aqtx.app.team.activity;
...
public class AdvancedTeamSearchActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.nim_advanced_team_search_activity);
        setTitle(com.aqtx.app.R.string.search_join_team);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.aqtx.app.R.string.search_join_team;
    ...
    private void findViews() {
        searchEditText = (ClearableEditTextWithIcon) findViewById(com.aqtx.app.R.id.team_search_edittext);
        searchEditText.setDeleteImage(com.aqtx.app.R.drawable.nim_grey_delete_icon);
    }
        ...
        toolbarView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(searchEditText.getText().toString())) {
                    Toast.makeText(AdvancedTeamSearchActivity.this, com.aqtx.app.R.string.not_allow_empty, Toast.LENGTH_SHORT).show();
                } else {
                    queryTeamById();
                }
            }
    ...
    private void queryTeamById() {
        NIMClient.getService(TeamService.class).searchTeam(searchEditText.getText().toString()).setCallback(new RequestCallback<Team>() {
            ...
            public void onFailed(int code) {
                if (code == 803) {
                    Toast.makeText(AdvancedTeamSearchActivity.this, com.aqtx.app.R.string.team_number_not_exist, Toast.LENGTH_LONG).show();
                } else {
