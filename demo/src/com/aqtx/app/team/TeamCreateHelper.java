...
public class TeamCreateHelper {
    ...
    public static void createNormalTeam(final Context context, List<String> memberAccounts, final boolean isNeedBack, final RequestCallback<Void> callback) {
        ...
        DialogMaker.showProgressDialog(context, context.getString(com.aqtx.app.R.string.empty), true);
        // 创建群
        ...
        NIMClient.getService(TeamService.class).createTeam(fields, TeamTypeEnum.Normal, "",
                ...
                new RequestCallback<Team>() {
                    ...
                    public void onSuccess(Team team) {
                        ...
                        Toast.makeText(DemoCache.getContext(), com.aqtx.app.R.string.create_team_success,
                    ...
                    public void onFailed(int code) {
                        DialogMaker.dismissProgressDialog();
                        if (code == 801) {
                            String tip = context.getString(com.aqtx.app.R.string.over_team_member_capacity, DEFAULT_TEAM_CAPACITY);
                            Toast.makeText(DemoCache.getContext(), tip,
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(DemoCache.getContext(), com.aqtx.app.R.string.create_team_failed,
                                    Toast.LENGTH_SHORT).show();
                        }
        ...
        NIMClient.getService(TeamService.class).createTeam(fields, type, "",
                ...
                new RequestCallback<Team>() {
                    ...
                    public void onFailed(int code) {
                        ...
                        String tip;
                        if (code == 801) {
                            tip = context.getString(com.aqtx.app.R.string.over_team_member_capacity,
                                    DEFAULT_TEAM_CAPACITY);
                        } else if (code == 806) {
                            tip = context.getString(com.aqtx.app.R.string.over_team_capacity);
                        } else {
                            tip = context.getString(com.aqtx.app.R.string.create_team_failed) + ", code=" +
                                    code;
                        }
    ...
    private static void onCreateSuccess(final Context context, final Team team) {
        ...
        DialogMaker.dismissProgressDialog();
        Toast.makeText(DemoCache.getContext(), com.aqtx.app.R.string.create_team_success, Toast.LENGTH_SHORT).show();
