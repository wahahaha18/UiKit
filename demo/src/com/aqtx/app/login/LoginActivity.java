...
//import com.aqtx.app.contact.ContactHttpClient;
...
//    private ClearableEditTextWithIcon registerPasswordConfirmEdit;
//
...
//                || "fe416640c8e8a72734219e1847ad2547".equals(appKey) || "2d09a46c72a413299eadae5bfc54e5e2".equals(appKey);
//
...
//        final String passwordConfirm = registerPasswordConfirmEdit.getText().toString();
//        // TODO: 2016/11/24 用户注册
//        OkHttpUtils.get().url("http://60.28.240.121:4505/index/CreateId")
//                .addParams("accid", account)
//                .addParams("token", password)
//                .addParams("name", nickName)
//                .build().execute(new StringCallback() {
//            @Override
//            public void onError(Call call, Exception e, int id) {
//                Toast.makeText(LoginActivity.this, "网络有误，请稍后重试", Toast.LENGTH_SHORT)
//                        .show();
//                DialogMaker.dismissProgressDialog();
//            }
//
...
//                    registerPasswordConfirmEdit.setText("");
//                    login();
//
//                } else {
...
//        String nickRegex = "^[\u4E00-\u9FA5a-zA-Z]{1,10}$";
...
////        }
////        确认密码检查
//        String confirmPwd = registerPasswordConfirmEdit.getText().toString().trim();
//        if (confirmPwd.length() < 6 || confirmPwd.length() > 20 || !password.equals(confirmPwd)) {
...
//            registerPasswordConfirmEdit = findView(R.id.edit_register_password_confirm);
//
...
//            registerPasswordConfirmEdit.setIconResource(R.drawable.user_pwd_lock_icon);
//
...
//            registerPasswordConfirmEdit.setFilters(new InputFilter[]{new InputFilter.LengthFilter(20)});
//
//
...
//            registerPasswordConfirmEdit.addTextChangedListener(textWatcher);
//
