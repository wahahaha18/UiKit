...
import com.aqtx.app.chatroom.viewholder.ChatRoomViewHolder;
import com.aqtx.app.chatroom.activity.ChatRoomActivity;
import com.aqtx.app.chatroom.adapter.ChatRoomAdapter;
import com.aqtx.app.chatroom.thridparty.ChatRoomHttpClient;
...
public class ChatRoomsFragment extends TFragment implements TAdapterDelegate, ChatRoomAdapter.ViewHolderEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.aqtx.app.R.layout.chat_rooms, container, false);
    }
    ...
    private void findViews() {
        // loading
        loadingFrame = findView(com.aqtx.app.R.id.contact_loading_frame);
        loadingFrame.setVisibility(View.VISIBLE);

        gridView = findView(com.aqtx.app.R.id.chat_room_grid_view);
