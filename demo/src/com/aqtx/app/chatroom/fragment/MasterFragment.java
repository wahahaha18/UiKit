...
public class MasterFragment extends TFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.aqtx.app.R.layout.master_fragment, container, false);
    }
    ...
    private void findViews() {
        imageView = findView(com.aqtx.app.R.id.master_head_image);
        imageView.loadAvatarByUrl(""); // 网络不好的时候，设置一个默认头像
        nameText = findView(com.aqtx.app.R.id.master_name);
        countText = findView(com.aqtx.app.R.id.online_total);
        announceText = findView(com.aqtx.app.R.id.announce_content);
        announceLayout = findView(com.aqtx.app.R.id.announce_layout);
        noAnnounceLayout = findView(com.aqtx.app.R.id.no_announce_layout);
    }
