...
import com.aqtx.app.chatroom.fragment.tab.ChatRoomTabFragment;
import com.aqtx.app.common.ui.viewpager.PagerSlidingTabStrip;
import com.aqtx.app.chatroom.adapter.ChatRoomTabPagerAdapter;
...
public class ChatRoomFragment extends ChatRoomTabFragment implements ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.aqtx.app.R.layout.chat_room_fragment, container, false);
    }
    ...
    private void findViews() {
        imageView = findView(com.aqtx.app.R.id.chat_room_view);
        statusText = findView(com.aqtx.app.R.id.online_status);
        final ImageView backImage = findView(com.aqtx.app.R.id.back_arrow);
        tabs = findView(com.aqtx.app.R.id.chat_room_tabs);
        viewPager = findView(com.aqtx.app.R.id.chat_room_viewpager);
    ...
    private void setupTabs() {
        tabs.setOnCustomTabListener(new PagerSlidingTabStrip.OnCustomTabListener() {
            ...
            public int getTabLayoutResId(int position) {
                return com.aqtx.app.R.layout.chat_room_tab_layout;
            }
