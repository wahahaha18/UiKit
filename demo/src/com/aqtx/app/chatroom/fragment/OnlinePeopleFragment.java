package com.aqtx.app.chatroom.fragment;
...
import com.aqtx.app.chatroom.viewholder.OnlinePeopleViewHolder;
import com.aqtx.app.DemoCache;
import com.aqtx.app.chatroom.activity.ChatRoomActivity;
import com.aqtx.app.chatroom.helper.ChatRoomMemberCache;
...
public class OnlinePeopleFragment extends TFragment implements TAdapterDelegate {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.aqtx.app.R.layout.online_people_fragment, container, false);
    }
    ...
    private void findViews() {
        onlineText = findView(com.aqtx.app.R.id.no_online_people);
        listView = findView(com.aqtx.app.R.id.chat_room_online_list);
...
//        listView.setOnItemLongClickListener(longClickListener); // 线上入口屏蔽成员操作
        ...
        ChatRoomMemberCache.getInstance().fetchMember(roomId, member.getAccount(), new SimpleCallback<ChatRoomMember>() {
            ...
            public void onResult(boolean success, ChatRoomMember result) {
                if (success) {
                    ...
                    Toast.makeText(getActivity(), com.aqtx.app.R.string.chatroom_fetch_member_failed, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void showLongClickMenu(final ChatRoomMember currentMember) {
        ...
        alertDialog.addItem(com.aqtx.app.R.string.chatroom_kick_member, new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
    ...
    private void addMutedItem(final ChatRoomMember chatRoomMember, CustomAlertDialog alertDialog) {
        int titleId = chatRoomMember.isMuted() ? com.aqtx.app.R.string.cancel_muted : com.aqtx.app.R.string.chatroom_muted;
    ...
    private void addBlackListItem(final ChatRoomMember chatRoomMember, CustomAlertDialog alertDialog) {
        int titleId = chatRoomMember.isInBlackList() ? com.aqtx.app.R.string.move_out_blacklist : com.aqtx.app.R.string.chatroom_blacklist;
        alertDialog.addItem(titleId, new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
    ...
    private void addAdminItem(final ChatRoomMember chatRoomMember, CustomAlertDialog alertDialog) {
        ...
        int titleId = isAdmin ? com.aqtx.app.R.string.cancel_admin : com.aqtx.app.R.string.chatroom_set_admin;
        alertDialog.addItem(titleId, new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
    ...
    private void addNormalItem(final ChatRoomMember chatRoomMember, CustomAlertDialog alertDialog) {
        ...
        int titleId = isNormal ? com.aqtx.app.R.string.cancel_normal_member : com.aqtx.app.R.string.set_normal_member;
        alertDialog.addItem(titleId, new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
    ...
    private void addTempMuteItemNotify(final ChatRoomMember chatRoomMember, CustomAlertDialog alertDialog) {
        alertDialog.addItem(com.aqtx.app.R.string.set_temp_mute_notify, new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
                final EasyEditDialog requestDialog = new EasyEditDialog(getActivity());
                requestDialog.setEditTextMaxLength(200);
                requestDialog.setTitle(getString(com.aqtx.app.R.string.mute_duration));
    ...
    private void addTemMuteItem(final ChatRoomMember chatRoomMember, CustomAlertDialog alertDialog) {
        alertDialog.addItem(com.aqtx.app.R.string.set_temp_mute_not_notify, new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
                final EasyEditDialog requestDialog = new EasyEditDialog(getActivity());
                requestDialog.setEditTextMaxLength(200);
    ...
    private void kickMember(final ChatRoomMember chatRoomMember) {
        ...
        NIMClient.getService(ChatRoomService.class).kickMember(roomId, chatRoomMember.getAccount(), reason).setCallback(new RequestCallback<Void>() {
            ...
            public void onSuccess(Void param) {
                Toast.makeText(getActivity(), com.aqtx.app.R.string.chatroom_kick_member, Toast.LENGTH_SHORT).show();
        ...
        NIMClient.getService(ChatRoomService.class).markChatRoomMutedList(!chatRoomMember.isMuted(), option)
                .setCallback(new RequestCallback<ChatRoomMember>() {
                    ...
                    public void onSuccess(ChatRoomMember param) {
                        Toast.makeText(getActivity(), com.aqtx.app.R.string.set_success, Toast.LENGTH_SHORT).show();
