package com.aqtx.app.chatroom.activity;
...
import com.aqtx.app.chatroom.fragment.ChatRoomMessageFragment;
import com.aqtx.app.chatroom.helper.ChatRoomMemberCache;
import com.aqtx.app.chatroom.fragment.ChatRoomFragment;
...
public class ChatRoomActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.chat_room_activity);
    ...
    Observer<ChatRoomStatusChangeData> onlineStatus = new Observer<ChatRoomStatusChangeData>() {
        ...
        public void onEvent(ChatRoomStatusChangeData chatRoomStatusChangeData) {
            if (chatRoomStatusChangeData.status == StatusCode.CONNECTING) {
                ...
                Toast.makeText(ChatRoomActivity.this, com.aqtx.app.R.string.net_broken, Toast.LENGTH_SHORT).show();
            }
    ...
    private void initChatRoomFragment() {
        fragment = (ChatRoomFragment) getSupportFragmentManager().findFragmentById(com.aqtx.app.R.id.chat_rooms_fragment);
        if (fragment != null) {
            fragment.updateView();
        } else {
    ...
    private void initMessageFragment() {
        messageFragment = (ChatRoomMessageFragment) getSupportFragmentManager().findFragmentById(com.aqtx.app.R.id.chat_room_message_fragment);
