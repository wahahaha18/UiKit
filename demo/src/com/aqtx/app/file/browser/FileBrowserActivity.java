package com.aqtx.app.file.browser;
...
public class FileBrowserActivity extends UI implements TAdapterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.file_browser_activity);
    ...
    private void findViews() {
        fileListView = (ListView) findViewById(com.aqtx.app.R.id.file_list);
    }
        ...
        fileListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (file.exists() && file.canRead()) {
                    ...
                    //没有权限
                    Toast.makeText(FileBrowserActivity.this, com.aqtx.app.R.string.no_permission, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
