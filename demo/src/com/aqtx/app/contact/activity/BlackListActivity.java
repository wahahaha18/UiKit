...
import com.aqtx.app.contact.viewholder.BlackListViewHolder;
...
public class BlackListActivity extends UI implements TAdapterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.black_list_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.aqtx.app.R.string.black_list;
    ...
    private void initActionbar() {
        ...
        toolbarView.setText(com.aqtx.app.R.string.add);
    ...
    private void findViews() {
        TextView notifyText = ((TextView) findView(com.aqtx.app.R.id.notify_bar).findViewById(com.aqtx.app.R.id.status_desc_label));
        notifyText.setText(com.aqtx.app.R.string.black_list_tip);
        notifyText.setBackgroundColor(getResources().getColor(com.aqtx.app.R.color.color_yellow_fcf3cd));
        notifyText.setTextColor(getResources().getColor(com.aqtx.app.R.color.color_yellow_796413));
        listView = findView(com.aqtx.app.R.id.black_list_view);
