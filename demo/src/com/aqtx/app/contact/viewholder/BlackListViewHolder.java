package com.aqtx.app.contact.viewholder;

import android.view.View;
import android.widget.Button;
import android.widget.TextView;

import com.aqtx.app.contact.activity.BlackListAdapter;
...
public class BlackListViewHolder extends TViewHolder {
    ...
    protected int getResId() {
        return com.aqtx.app.R.layout.black_list_item;
    }

    @Override
    protected void inflate() {
        headImageView = findView(com.aqtx.app.R.id.head_image);
        accountText = findView(com.aqtx.app.R.id.account);
        removeBtn = findView(com.aqtx.app.R.id.remove);
    }
