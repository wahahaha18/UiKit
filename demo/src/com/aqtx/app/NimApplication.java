...
import com.aqtx.app.common.util.crash.AppCrashHandler;
import com.aqtx.app.config.preference.Preferences;
import com.aqtx.app.contact.ContactHelper;
import com.aqtx.app.main.helper.AppUtil;
import com.aqtx.app.session.NimDemoLocationProvider;
import com.aqtx.app.avchat.AVChatProfile;
import com.aqtx.app.common.util.sys.SystemUtil;
import com.aqtx.app.config.ExtraOptions;
...
public class NimApplication extends Application {
    ...
    public void onCreate() {
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                .addInterceptor(new LoggerInterceptor("ycl"))
...
//            HttpManager.getInstance().post(url, new StringCallback() {
//                @Override
...
//                    int oldVersion = AppUtil.getAppVersionCode(getApplicationContext());
