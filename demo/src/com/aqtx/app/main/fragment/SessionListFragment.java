...
import com.aqtx.app.main.activity.MultiportActivity;
...
public class SessionListFragment extends MainTabFragment {
    ...
    private void findViews() {
        notifyBar = getView().findViewById(com.aqtx.app.R.id.status_notify_bar);
        notifyBarText = (TextView) getView().findViewById(com.aqtx.app.R.id.status_desc_label);
        notifyBar.setVisibility(View.GONE);

        multiportBar = getView().findViewById(com.aqtx.app.R.id.multiport_notify_bar);
        ...
        public void onEvent(StatusCode code) {
            if (code.wontAutoLogin()) {
                ...
                if (code == StatusCode.NET_BROKEN) {
                    ...
                    notifyBarText.setText(com.aqtx.app.R.string.net_broken);
                } else if (code == StatusCode.UNLOGIN) {
                    notifyBar.setVisibility(View.VISIBLE);
                    notifyBarText.setText(com.aqtx.app.R.string.nim_status_unlogin);
                } else if (code == StatusCode.CONNECTING) {
                    notifyBar.setVisibility(View.VISIBLE);
                    notifyBarText.setText(com.aqtx.app.R.string.nim_status_connecting);
                } else if (code == StatusCode.LOGINING) {
                    notifyBar.setVisibility(View.VISIBLE);
                    notifyBarText.setText(com.aqtx.app.R.string.nim_status_logining);
                } else {
                    notifyBar.setVisibility(View.GONE);
                }
            }
    ...
    Observer<List<OnlineClient>> clientsObserver = new Observer<List<OnlineClient>>() {
        ...
        public void onEvent(List<OnlineClient> onlineClients) {
            ...
            if (onlineClients == null || onlineClients.size() == 0) {
                ...
                TextView status = (TextView) multiportBar.findViewById(com.aqtx.app.R.id.multiport_desc_label);
                OnlineClient client = onlineClients.get(0);
                switch (client.getClientType()) {
                    case ClientType.Windows:
                        status.setText(getString(com.aqtx.app.R.string.multiport_logging) + getString(com.aqtx.app.R.string.computer_version));
                        break;
                    case ClientType.Web:
                        status.setText(getString(com.aqtx.app.R.string.multiport_logging) + getString(com.aqtx.app.R.string.web_version));
                        break;
                    case ClientType.iOS:
                    case ClientType.Android:
                        status.setText(getString(com.aqtx.app.R.string.multiport_logging) + getString(com.aqtx.app.R.string.mobile_version));
                        break;
                    default:
                        multiportBar.setVisibility(View.GONE);
                        break;
    ...
    private void kickOut(StatusCode code) {
        ...
        if (code == StatusCode.PWD_ERROR) {
            ...
            Toast.makeText(getActivity(), com.aqtx.app.R.string.login_failed, Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void addRecentContactsFragment() {
        ...
        fragment.setContainerId(com.aqtx.app.R.id.messages_fragment);
