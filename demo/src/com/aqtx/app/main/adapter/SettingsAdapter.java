package com.aqtx.app.main.adapter;
...
public class SettingsAdapter extends BaseAdapter {
    ...
    public SettingsAdapter(Context context, SwitchChangeListener switchChangeListener, List<SettingTemplate> items) {
        this(context, switchChangeListener, items, com.aqtx.app.R.layout.setting_item_base);
    }
    ...
    public SettingsAdapter(Context context, SwitchChangeListener switchChangeListener, List<SettingTemplate> items, int layoutID) {
        ...
        itemHeight = context.getResources().getDimensionPixelSize(com.aqtx.app.R.dimen.isetting_item_height);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (viewHolder == null) {
            ...
            viewHolder.headImageView = (HeadImageView) convertView.findViewById(com.aqtx.app.R.id.head_image);
            viewHolder.titleView = (TextView) convertView.findViewById(com.aqtx.app.R.id.title_label);
            viewHolder.detailView = (TextView) convertView.findViewById(com.aqtx.app.R.id.detail_label);
            viewHolder.switchButton = (SwitchButton) convertView.findViewById(com.aqtx.app.R.id.setting_item_toggle);
            viewHolder.line = convertView.findViewById(com.aqtx.app.R.id.line);
            viewHolder.indicator = (ImageView) convertView.findViewById(com.aqtx.app.R.id.setting_item_indicator);
            viewHolder.headTitleView = (TextView) convertView.findViewById(com.aqtx.app.R.id.head_title_label);
            viewHolder.headDetailView = (TextView) convertView.findViewById(com.aqtx.app.R.id.head_detail_label);
            viewHolder.imageView = (TextView) convertView.findViewById(R.id.setting_item_about);
        ...
        viewHolder.root.setBackgroundResource(com.aqtx.app.R.drawable.nim_semitransparency_selector);
        ...
        } else if (item.getType() == SettingType.TYPE_ABOUT) {
            updateAboutItem(viewHolder, item, position);
        } else {
    ...
    private void updateAboutItem(ViewHolder viewHolder, SettingTemplate item, int position) {
        setTextView(viewHolder.titleView, item.getTitle());
     ...
     * @param viewHolder
     */
    private void updateHeadItem(final ViewHolder viewHolder) {
        ViewGroup.LayoutParams lp = viewHolder.root.getLayoutParams();
        if (lp != null) {
            lp.height = 200;
            viewHolder.root.setLayoutParams(lp);
        ...
        NimUserInfoCache.getInstance().getUserInfoFromRemote(DemoCache.getAccount(), new RequestCallback<NimUserInfo>() {
            @Override
            public void onSuccess(NimUserInfo nimUserInfo) {
                viewHolder.headDetailView.setText(String.format("帐号:%s", TextUtils.isEmpty(nimUserInfo.getExtension()) ? "" : nimUserInfo.getExtension()));
            }
        ...
        viewHolder.indicator.setImageResource(com.aqtx.app.R.drawable.nim_arrow_right);
