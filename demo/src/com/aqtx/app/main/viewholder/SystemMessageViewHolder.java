package com.aqtx.app.main.viewholder;

import android.view.View;
import android.widget.Button;
import android.widget.TextView;

import com.aqtx.app.main.helper.MessageHelper;
...
public class SystemMessageViewHolder extends TViewHolder {
    ...
    protected int getResId() {
        return com.aqtx.app.R.layout.message_system_notification_view_item;
    }

    @Override
    protected void inflate() {
        headImageView = (HeadImageView) view.findViewById(com.aqtx.app.R.id.from_account_head_image);
        fromAccountText = (TextView) view.findViewById(com.aqtx.app.R.id.from_account_text);
        contentText = (TextView) view.findViewById(com.aqtx.app.R.id.content_text);
        timeText = (TextView) view.findViewById(com.aqtx.app.R.id.notification_time);
        operatorLayout = view.findViewById(com.aqtx.app.R.id.operator_layout);
        agreeButton = (Button) view.findViewById(com.aqtx.app.R.id.agree);
        rejectButton = (Button) view.findViewById(com.aqtx.app.R.id.reject);
        operatorResultText = (TextView) view.findViewById(com.aqtx.app.R.id.operator_result);
    ...
    private void setReplySending() {
        ...
        rejectButton.setVisibility(View.GONE);
        operatorResultText.setVisibility(View.VISIBLE);
        operatorResultText.setText(com.aqtx.app.R.string.team_apply_sending);
    }
}
