...
import com.aqtx.app.common.util.sys.SysInfoUtil;
...
public class WelcomeActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.activity_welcome);
...
//        findView(R.id.layout_first).setVisibility(View.VISIBLE);
