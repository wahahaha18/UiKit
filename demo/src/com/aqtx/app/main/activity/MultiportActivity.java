...
public class MultiportActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.multiport_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.aqtx.app.R.string.multiport_manager;
    ...
    private void findViews() {
        versionLayout = findView(com.aqtx.app.R.id.versions);
    }
        ...
        for(OnlineClient client : onlineClients) {
            ...
            switch (client.getClientType()) {
                case ClientType.Windows:
                    clientName.setText(com.aqtx.app.R.string.computer_version);
                    break;
                case ClientType.Web:
                    clientName.setText(com.aqtx.app.R.string.web_version);
                    break;
                case ClientType.Android:
                case ClientType.iOS:
                    clientName.setText(com.aqtx.app.R.string.mobile_version);
                    break;
                default:
                    break;
            }
    ...
    private TextView initVersionView(OnlineClient client) {
        ...
        final View view = getLayoutInflater().inflate(com.aqtx.app.R.layout.multiport_item, null);
        versionLayout.addView(view);
        TextView clientName = (TextView) view.findViewById(com.aqtx.app.R.id.client_name);
        TextView clientLogout = (TextView) view.findViewById(com.aqtx.app.R.id.client_logout);
