...
public class TeamListActivity extends UI implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.group_list_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = itemType == ItemTypes.TEAMS.ADVANCED_TEAM ? com.aqtx.app.R.string.advanced_team : com.aqtx.app.R.string.normal_team;
        setToolBar(com.aqtx.app.R.id.toolbar, options);

        lvContacts = (ListView) findViewById(com.aqtx.app.R.id.group_list);
        ...
        if (count == 0) {
            if (itemType == ItemTypes.TEAMS.ADVANCED_TEAM) {
                Toast.makeText(TeamListActivity.this, com.aqtx.app.R.string.no_team, Toast.LENGTH_SHORT).show();
            } else if (itemType == ItemTypes.TEAMS.NORMAL_TEAM) {
                Toast.makeText(TeamListActivity.this, com.aqtx.app.R.string.no_normal_team, Toast.LENGTH_SHORT).show();
            }
        }
