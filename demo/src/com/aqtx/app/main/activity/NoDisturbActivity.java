...
public class NoDisturbActivity extends UI implements SettingsAdapter.SwitchChangeListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.no_disturb_activity);
        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.aqtx.app.R.string.no_disturb;
    ...
    private void findViews() {
        initItems();
        noDisturbList = (ListView) findViewById(com.aqtx.app.R.id.no_disturb_list);
        initFooter();
    ...
    private void initFooter() {
        View footer = LayoutInflater.from(this).inflate(com.aqtx.app.R.layout.no_disturb_footer, null);
        timeLayout = footer.findViewById(com.aqtx.app.R.id.time_layout);
        startLayout = (RelativeLayout) footer.findViewById(com.aqtx.app.R.id.start_time_layout);
        endLayout = (RelativeLayout) footer.findViewById(com.aqtx.app.R.id.end_time_layout);
        startText = (TextView) footer.findViewById(com.aqtx.app.R.id.start_time_value);
        endText = (TextView) footer.findViewById(com.aqtx.app.R.id.end_time_value);
    ...
    private void initItems() {
        items.clear();
        items.add(new SettingTemplate(TAG_NO_DISTURB, getString(com.aqtx.app.R.string.no_disturb), SettingType.TYPE_TOGGLE, UserPreferences.getDownTimeToggle()));
    ...
    private void parseIntentData() {
        ...
        if(ischecked) {
            ...
            if (time.length() < 11) {
                startTime = getString(com.aqtx.app.R.string.time_from_default);
                endTime = getString(com.aqtx.app.R.string.time_to_default);
            } else {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.aqtx.app.R.id.start_time_layout:
                openFromTimePicker(true, startText.getText().toString());
                break;
            case com.aqtx.app.R.id.end_time_layout:
