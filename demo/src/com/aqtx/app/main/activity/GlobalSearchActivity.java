...
public class GlobalSearchActivity extends UI implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.global_search_result);
        ToolBarOptions options = new ToolBarOptions();
        setToolBar(com.aqtx.app.R.id.toolbar, options);

        lvContacts = (ListView) findViewById(com.aqtx.app.R.id.searchResultList);
        lvContacts.setVisibility(View.GONE);
        ...
        findViewById(com.aqtx.app.R.id.global_search_root).setOnTouchListener(new OnTouchListener() {
