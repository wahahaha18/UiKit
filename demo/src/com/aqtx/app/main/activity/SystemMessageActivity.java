...
import com.aqtx.app.main.adapter.SystemMessageAdapter;
import com.aqtx.app.main.viewholder.SystemMessageViewHolder;
...
public class SystemMessageActivity extends UI implements TAdapterDelegate,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.titleId = com.aqtx.app.R.string.verify_reminder;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.aqtx.app.R.menu.notification_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.aqtx.app.R.id.notification_menu_btn:
                deleteAllMessages();
                break;
            default:
                break;
    ...
    private void deleteAllMessages() {
        ...
        items.clear();
        refresh();
        Toast.makeText(SystemMessageActivity.this, com.aqtx.app.R.string.clear_all_success, Toast.LENGTH_SHORT).show();
    }

    private void showLongClickMenu(final SystemMessage message) {
        CustomAlertDialog alertDialog = new CustomAlertDialog(this);
        alertDialog.setTitle(com.aqtx.app.R.string.delete_tip);
        String title = getString(com.aqtx.app.R.string.delete_system_message);
    ...
    private void deleteSystemMessage(final SystemMessage message) {
        ...
        refresh();
        Toast.makeText(SystemMessageActivity.this, com.aqtx.app.R.string.delete_success, Toast.LENGTH_SHORT).show();
    }
}
