...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.settings_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.aqtx.app.R.string.settings;
...
//            Toast.makeText(SettingsActivity.this, "收到multiport push config：" + aBoolean, Toast.LENGTH_SHORT).show();
    ...
    private void initUI() {
        initItems();
        listView = (ListView) findViewById(com.aqtx.app.R.id.settings_listview);
        View footer = LayoutInflater.from(this).inflate(com.aqtx.app.R.layout.settings_logout_footer, null);
    ...
    private void initItems() {
        ...
        items.add(SettingTemplate.addLine());
        items.add(SettingTemplate.addLine());
        items.add(new SettingTemplate(TAG_ABOUT, getString(com.aqtx.app.R.string.setting_about)));
        // TODO: 2016/9/21   修改密码
        items.add(SettingTemplate.addLine());
    ...
    private void onListItemClick(SettingTemplate item) {
        ...
        switch (item.getId()) {
            ...
            case TAG_CLEAR:
                ...
                Toast.makeText(SettingsActivity.this, com.aqtx.app.R.string.clear_msg_history_success, Toast.LENGTH_SHORT).show();
                break;
