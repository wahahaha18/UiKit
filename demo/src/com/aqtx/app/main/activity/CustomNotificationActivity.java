...
import com.aqtx.app.main.viewholder.CustomNotificationViewHolder;
import com.aqtx.app.DemoCache;
import com.aqtx.app.main.helper.CustomNotificationCache;
...
public class CustomNotificationActivity extends UI implements TAdapterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.system_notification_message_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.aqtx.app.R.string.custom_notification;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.aqtx.app.R.menu.custom_notification_activity_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.aqtx.app.R.id.send_custom_notification_to_team:
                selectCustomNotificationTarget(true);
                break;
            case com.aqtx.app.R.id.send_custom_notification_to_buddy:
    ...
    private void initListView() {
        listView = (MessageListView) findViewById(com.aqtx.app.R.id.messageListView);
    ...
    private void selectCustomNotificationTarget(boolean team) {
        ...
        option.title = DemoCache.getContext().getString(com.aqtx.app.R.string.select_custom_notification_target);
        option.multi = false;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CONTACT_SELECT_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            if (selected != null && !selected.isEmpty()) {
                ...
                requestDialog.setTitle(getString(com.aqtx.app.R.string.send_custom_notification_tip));
    ...
    private void sendCustomNotification(String account, String content) {
        ...
        NIMClient.getService(MsgService.class).sendCustomNotification(notification).setCallback(new RequestCallback<Void>() {
            ...
            public void onSuccess(Void param) {
                Toast.makeText(CustomNotificationActivity.this, com.aqtx.app.R.string.send_custom_notification_success, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailed(int code) {
                Toast.makeText(CustomNotificationActivity.this, com.aqtx.app.R.string.send_custom_notification_failed, Toast.LENGTH_SHORT).show();
            }
