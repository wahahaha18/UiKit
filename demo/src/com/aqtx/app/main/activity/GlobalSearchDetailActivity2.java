...
public class GlobalSearchDetailActivity2 extends UI implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.global_search_detail);
        ...
        TextView tipTextView = findView(com.aqtx.app.R.id.search_result_tip);
        tipTextView.setText(tip);

        // listView adapter
        lvContacts = findView(com.aqtx.app.R.id.search_result_list);
