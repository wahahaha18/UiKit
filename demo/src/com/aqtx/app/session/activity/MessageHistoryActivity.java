...
public class MessageHistoryActivity extends UI implements ModuleProxy {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View rootView = LayoutInflater.from(this).inflate(com.aqtx.app.R.layout.message_history_activity, null);
        setContentView(rootView);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.aqtx.app.R.string.message_history_query;
