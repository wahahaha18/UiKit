package com.aqtx.app.session.activity;
...
public class MessageInfoActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.message_info_activity);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = com.aqtx.app.R.string.message_info;
        options.navigateId = com.aqtx.app.R.drawable.actionbar_dark_back_icon;
    ...
    private void findViews() {
        HeadImageView userHead = (HeadImageView) findViewById(com.aqtx.app.R.id.user_layout).findViewById(com.aqtx.app.R.id.imageViewHeader);
        TextView userName = (TextView) findViewById(com.aqtx.app.R.id.user_layout).findViewById(com.aqtx.app.R.id.textViewName);
    ...
    private SwitchButton.OnChangedListener onChangedListener = new SwitchButton.OnChangedListener() {
        ...
        public void OnChanged(View v, final boolean checkState) {
            if (!NetworkUtil.isNetAvailable(MessageInfoActivity.this)) {
                Toast.makeText(MessageInfoActivity.this, com.aqtx.app.R.string.network_is_not_available, Toast.LENGTH_SHORT).show();
