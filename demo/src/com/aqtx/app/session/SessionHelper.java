...
import com.aqtx.app.session.action.AVChatAction;
import com.aqtx.app.session.action.FileAction;
import com.aqtx.app.session.action.GuessAction;
import com.aqtx.app.session.action.RTSAction;
import com.aqtx.app.session.action.SnapChatAction;
import com.aqtx.app.session.action.TipAction;
import com.aqtx.app.session.activity.MessageHistoryActivity;
import com.aqtx.app.session.activity.MessageInfoActivity;
import com.aqtx.app.session.extension.CustomAttachment;
import com.aqtx.app.session.extension.RTSAttachment;
import com.aqtx.app.session.extension.SnapChatAttachment;
import com.aqtx.app.session.extension.StickerAttachment;
import com.aqtx.app.session.search.SearchMessageActivity;
import com.aqtx.app.session.viewholder.MsgViewHolderAVChat;
import com.aqtx.app.session.viewholder.MsgViewHolderDefCustom;
import com.aqtx.app.session.viewholder.MsgViewHolderGuess;
import com.aqtx.app.session.viewholder.MsgViewHolderRTS;
import com.aqtx.app.session.viewholder.MsgViewHolderSnapChat;
import com.aqtx.app.session.viewholder.MsgViewHolderSticker;
import com.aqtx.app.session.viewholder.MsgViewHolderTip;
import com.aqtx.app.session.extension.CustomAttachParser;
import com.aqtx.app.session.extension.GuessAttachment;
import com.aqtx.app.session.viewholder.MsgViewHolderFile;
...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.demo/drawable/bk"
            ...
            cloudMsgButton.iconId = com.aqtx.app.R.drawable.nim_ic_messge_history;
            ...
            infoButton.iconId = com.aqtx.app.R.drawable.nim_ic_message_actionbar_p2p_add;
...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.demo/drawable/bk"
            ...
            SessionCustomization.OptionsButton infoButton = new SessionCustomization.OptionsButton() {
                ...
                public void onClick(Context context, View view, String sessionId) {
                    ...
                    if (team != null && team.isMyTeam()) {
                        ...
                        Toast.makeText(context, com.aqtx.app.R.string.team_invalid_tip, Toast.LENGTH_SHORT).show();
                    }
                }
            };
            infoButton.iconId = com.aqtx.app.R.drawable.nim_ic_message_actionbar_team;
            buttons.add(cloudMsgButton);
            buttons.add(infoButton);
    ...
    private static List<PopupMenuItem> getMoreMenuItems(Context context, String sessionId, SessionTypeEnum sessionTypeEnum) {
        ...
        moreMenuItems.add(new PopupMenuItem(context, ACTION_CLEAR_MESSAGE, sessionId,
                sessionTypeEnum, DemoCache.getContext().getString(com.aqtx.app.R.string.message_clear)));
