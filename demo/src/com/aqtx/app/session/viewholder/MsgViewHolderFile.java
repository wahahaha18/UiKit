...
import com.aqtx.app.file.FileIcons;
...
public class MsgViewHolderFile extends MsgViewHolderBase {
    ...
    protected int getContentResId() {
        return com.aqtx.app.R.layout.nim_message_item_file;
    }

    @Override
    protected void inflateContentView() {
        fileIcon = (ImageView) view.findViewById(com.aqtx.app.R.id.message_item_file_icon_image);
        fileNameLabel = (TextView)view.findViewById(com.aqtx.app.R.id.message_item_file_name_label);
        fileStatusLabel = (TextView)view.findViewById(com.aqtx.app.R.id.message_item_file_status_label);
        progressBar = (ProgressBar) view.findViewById(com.aqtx.app.R.id.message_item_file_transfer_progress_bar);
    }
    ...
    private void updateFileStatusLabel() {
        ...
        if (AttachmentStore.isFileExist(path)) {
            sb.append(context.getString(com.aqtx.app.R.string.file_transfer_state_downloaded));
        } else {
            sb.append(context.getString(com.aqtx.app.R.string.file_transfer_state_undownload));
        }
        fileStatusLabel.setText(sb.toString());
    }
