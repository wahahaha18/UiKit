...
import com.aqtx.app.session.activity.WatchSnapChatPictureActivity;
...
public class MsgViewHolderSnapChat extends MsgViewHolderBase {
    ...
    protected int getContentResId() {
        return com.aqtx.app.R.layout.nim_message_item_snapchat;
    }

    @Override
    protected void inflateContentView() {
        thumbnailImageView = (ImageView) view.findViewById(com.aqtx.app.R.id.message_item_snap_chat_image);
        progressBar = findViewById(com.aqtx.app.R.id.message_item_thumb_progress_bar); // 覆盖掉
        progressCover = findViewById(com.aqtx.app.R.id.message_item_thumb_progress_cover);
        progressLabel = (TextView) view.findViewById(com.aqtx.app.R.id.message_item_thumb_progress_text);
    }
    ...
    private void refreshStatus() {
        thumbnailImageView.setBackgroundResource(isReceivedMessage() ? com.aqtx.app.R.drawable.message_view_holder_left_snapchat : com.aqtx.app.R.drawable.message_view_holder_right_snapchat);
    ...
    private void layoutByDirection() {
        View body = findViewById(com.aqtx.app.R.id.message_item_snap_chat_body);
        View tips = findViewById(com.aqtx.app.R.id.message_item_snap_chat_tips_label);
