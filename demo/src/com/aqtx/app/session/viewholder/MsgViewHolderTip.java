...
public class MsgViewHolderTip extends MsgViewHolderBase {
    ...
    protected int getContentResId() {
        return com.aqtx.app.R.layout.nim_message_item_notification;
    }

    @Override
    protected void inflateContentView() {
        notificationTextView = (TextView) view.findViewById(com.aqtx.app.R.id.message_item_notification_label);
    }
