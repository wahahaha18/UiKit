...
public class MsgViewHolderSticker extends MsgViewHolderBase {
    ...
    protected int getContentResId() {
        return com.aqtx.app.R.layout.nim_message_item_sticker;
    }

    @Override
    protected void inflateContentView() {
        baseView = findViewById(com.aqtx.app.R.id.message_item_sticker_image);
    ...
    protected void bindContentView() {
        ...
        ImageLoader.getInstance().displayImage(StickerManager.getInstance().getStickerBitmapUri(attachment.getCatalog
                ...
                (ScreenUtil.dip2px(com.aqtx.app.R.dimen.mask_sticker_bubble_width)));
    }
