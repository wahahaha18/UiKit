package com.aqtx.app.session.search;
...
public class SearchMessageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(com.aqtx.app.R.layout.message_search_list_view_item, parent, false);
    ...
    private class TextSearchResultViewHolder {
        ...
        public TextSearchResultViewHolder(View view) {
            this.imgHead = (HeadImageView) view.findViewById(com.aqtx.app.R.id.img_head);

            this.tvNickname = (TextView) view.findViewById(com.aqtx.app.R.id.tv_nick_name);
            this.tvMessage = (TextView) view.findViewById(com.aqtx.app.R.id.tv_message);
            this.tvDatetime = (TextView) view.findViewById(com.aqtx.app.R.id.tv_date_time);
            this.imgMsgStatus = (ImageView) view.findViewById(com.aqtx.app.R.id.img_msg_status);
        }
...
//            SpanUtil.makeKeywordSpan(context, tvMessage, keyword);
            ...
            case fail:
                imgMsgStatus.setImageResource(com.aqtx.app.R.drawable.nim_g_ic_failed_small);
