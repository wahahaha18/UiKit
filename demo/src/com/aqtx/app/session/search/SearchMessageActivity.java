...
public class SearchMessageActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.message_search_activity);

        ToolBarOptions options = new ToolBarOptions();
        setToolBar(com.aqtx.app.R.id.toolbar, options);

        findViewById(com.aqtx.app.R.id.global_search_root).setOnTouchListener(new View.OnTouchListener() {
    ...
    private void initSearchListView() {
        searchResultListView = (AutoRefreshListView) findViewById(com.aqtx.app.R.id.searchResultList);
        searchResultListView.setMode(AutoRefreshListView.Mode.END);
        searchResultListView.setVisibility(View.GONE);
        searchResultListView.setEmptyView(LayoutInflater.from(this).inflate(com.aqtx.app.R.layout.message_search_empty_view, null));
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        getMenuInflater().inflate(com.aqtx.app.R.menu.global_search_menu, menu);
        final MenuItem item = menu.findItem(com.aqtx.app.R.id.action_search);
