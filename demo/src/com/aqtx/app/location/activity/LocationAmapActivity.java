...
import com.aqtx.app.location.helper.NimGeocoder;
...
//	private static final String TAG = "LocationAmapActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aqtx.app.R.layout.map_view_amap_layout);
    ...
    private void initView() {
		...
		sendButton.setText(com.aqtx.app.R.string.send);
		sendButton.setOnClickListener(this);
    	sendButton.setVisibility(View.INVISIBLE);
    	
    	pinView = (ImageView) findViewById(com.aqtx.app.R.id.location_pin);
    	pinInfoPanel = findViewById(com.aqtx.app.R.id.location_info);
    	pinInfoTextView = (TextView) pinInfoPanel.findViewById(com.aqtx.app.R.id.marker_address);

    	pinView.setOnClickListener(this);
    	pinInfoPanel.setOnClickListener(this);
    	
    	
    	btnMyLocation = (Button) findViewById(com.aqtx.app.R.id.my_location);
    ...
    private void updateSendStatus() {
    	...
    	int titleResID = com.aqtx.app.R.string.location_map;
    	if(TextUtils.isEmpty(addressInfo)) {
    		titleResID = com.aqtx.app.R.string.location_loading;
    	...
    	if(btnMyLocation.getVisibility() == View.VISIBLE || Math.abs(-1 - cacheLatitude) < 0.1f) {
    		...
    		setTitle(com.aqtx.app.R.string.my_location);
    	}
    }
    ...
    private void sendLocation() {
        ...
        addressInfo = TextUtils.isEmpty(addressInfo) ? getString(com.aqtx.app.R.string.location_address_unkown) : addressInfo;
    ...
    public void onClick(View v) {
        ...
        case com.aqtx.app.R.id.action_bar_right_clickable_textview:
            ...
            finish();
            break;
        case com.aqtx.app.R.id.location_pin:
        	setPinInfoPanel(!isPinInfoPanelShow());
            break;
        case com.aqtx.app.R.id.location_info:
        	pinInfoPanel.setVisibility(View.GONE);
            break;
        case com.aqtx.app.R.id.my_location:
        ...
        public void onGeoCoderResult(NimLocation location) {
            if(latitude == location.getLatitude() && longitude == location.getLongitude()) { // 响应的是当前查询经纬度
                if(location.hasAddress()) {
                    ...
                    addressInfo = getString(com.aqtx.app.R.string.location_address_unkown);
                }
                setPinInfoPanel(true);
                clearTimeoutHandler();
            }
	...
	private Runnable runable = new Runnable() {
		@Override
		public void run() {
			LocationAmapActivity.this.addressInfo = getString(com.aqtx.app.R.string.location_address_unkown);
			setPinInfoPanel(true);
		}
	};
