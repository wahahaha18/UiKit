...
package com.aqtx.app.location.adapter;
...
public class IconListAdapter extends ArrayAdapter<IconListAdapter.IconListItem> {
    ...
    private static final int mResource = com.aqtx.app.R.layout.icon_list_item;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Set text field
        text = (TextView) view.findViewById(com.aqtx.app.R.id.text1);
        text.setText(getItem(position).getTitle());

        // Set resource icon
        image = (ImageView) view.findViewById(com.aqtx.app.R.id.icon);
